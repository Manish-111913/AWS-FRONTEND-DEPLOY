...
- `ProfilePage` – User profile, stats, quick settings, account menu list.
- `QrBillingApp` – Shell container providing tab switching (Menu / Cart / Orders / Profile) & shared cart state.
...
- Add auth context to hydrate `ProfilePage` with actual user info.
